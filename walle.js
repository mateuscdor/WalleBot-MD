...
hey recuerda que puedes usar /hidetag + un mensaje para mencionar a todos los usuarios sin @
...
if (isBannedUser) return reply(answer.banneduser) 
if (isBannedGroup) return reply(answer.bannedgroup)
let anu = await fetchJson(`https://zenzapis.xyz/stalker/tiktok?username=${text}&apikey=${zenapi}`)
...
if (isBannedUser) return reply(answer.banneduser) 
if (isBannedGroup) return reply(answer.bannedgroup)
let anu = await fetchJson(`https://api.nxr.my.id/api/igstalk?username=${text}&apikey=${nxrapi}`)
...
if (isBannedUser) return reply(answer.banneduser) 
if (isBannedGroup) return reply(answer.bannedgroup)
let anu = await fetchJson(`https://zenzapis.xyz/stalker/github?username=${text}&apikey=${zenapi}`)
...
case 'covidindo':
case 'covid':{
let anu = await fetchJson(`https://zenzapis.xyz/information/covidworld?apikey=${zenapi}`)
...
if (isBannedUser) return reply(answer.banneduser)
if (isBannedGroup) return reply(answer.bannedgroup) 
let anu = await fetchJson(`https://some-random-api.ml/animal/dog`)
var wbuttsss = [
{buttonId: `${prefix + command}`, buttonText: {displayText: `Siguiente ▶️`}, type: 1},
]
...
if (isBannedUser) return reply(answer.banneduser)
if (isBannedGroup) return reply(answer.bannedgroup) 
let anu = await fetchJson(`https://some-random-api.ml/animal/cat`)
var wbuttsss = [
{buttonId: `${prefix + command}`, buttonText: {displayText: `Siguiente ▶️`}, type: 1},
]
...
if (isBannedUser) return reply(answer.banneduser)
if (isBannedGroup) return reply(answer.bannedgroup) 
let anu = await fetchJson(`https://some-random-api.ml/animal/panda`)
var wbuttsss = [
{buttonId: `${prefix + command}`, buttonText: {displayText: `Siguiente ▶️`}, type: 1},
]
...
if (isBannedUser) return reply(answer.banneduser)
if (isBannedGroup) return reply(answer.bannedgroup) 
let anu = await fetchJson(`https://some-random-api.ml/animal/fox`)
var wbuttsss = [
{buttonId: `${prefix + command}`, buttonText: {displayText: `Siguiente ▶️`}, type: 1},
]
...
if (isBannedUser) return reply(answer.banneduser)
if (isBannedGroup) return reply(answer.bannedgroup) 
let anu = await fetchJson(`https://some-random-api.ml/animal/red_panda`)
var wbuttsss = [
{buttonId: `${prefix + command}`, buttonText: {displayText: `Siguiente ▶️`}, type: 1},
]
...
if (isBannedUser) return reply(answer.banneduser)
if (isBannedGroup) return reply(answer.bannedgroup) 
let anu = await fetchJson(`https://some-random-api.ml/animal/koala`)
var wbuttsss = [
{buttonId: `${prefix + command}`, buttonText: {displayText: `Siguiente ▶️`}, type: 1},
]
...
if (isBannedUser) return reply(answer.banneduser)
if (isBannedGroup) return reply(answer.bannedgroup) 
let anu = await fetchJson(`https://some-random-api.ml/animal/bird`)
var wbuttsss = [
{buttonId: `${prefix + command}`, buttonText: {displayText: `Siguiente ▶️`}, type: 1},
]
