...
walle.sendMessage(callerId, { text: `_Hey llamar al bot esta prohibido, lamentablemente seras bloqueado(a) si llamaste por error entonces comunícate con mi desarrollador wa.me/5215621341581_`}, { quoted : wallefek })
await sleep(5000)
